...
import { registrationTestimonials } from "../../utility/config";

const RegistrationTestimonial = ({ isMobile, setOpenRegistration }) => (
  <Carousel autoplay fade dotPosition="bottom">
    {registrationTestimonials.map((testimonial, i) => (
      <div
        key={i}
