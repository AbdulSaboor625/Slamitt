...
const CompetitionDetailsHeaderModule = ({
  competitionState = {},
  crew = false,
  containerState,
}) => {
    ...
    <>
      ...
      {crew ? (
        <Typography.Title className="invitationFormTitle">
          <span className="titlePrefix">Register for</span> {competitionState?.competitionName} as crew on Slamitt
        </Typography.Title>
      ) : (
        <Typography.Title className="invitationFormTitle">
          <span className="titlePrefix">Register for</span> {competitionState?.competitionName} as{"  "}
      ...
      <div className="invitationFormInfo">
        ...
        <Typography.Text className="invitationFormText">
          <MultipleUserIcon />
          {competitionState?.competitionType === "SOLO" ? "Solo" : "Team"}&nbsp;Event
        </Typography.Text>
        {crew && (
...
export default CompetitionDetailsHeaderModule;
