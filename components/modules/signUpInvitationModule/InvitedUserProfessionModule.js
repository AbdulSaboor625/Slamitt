...
import InstituteSelect from "../signup/InstituteSelect";
import styles from "./signup.module.scss";

const InvitedUserProfessionModule = ({ email, userCode, children }) => {
  ...
  const onFinish = async (value) => {
    ...
    if (
      ...
      form.getFieldValue("institute").toLowerCase() === "other"
    ) {
...
export default InvitedUserProfessionModule;
