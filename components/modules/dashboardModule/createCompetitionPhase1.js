        ...
        <div className="nameCompetitionForm">
          ...
          {!isVisibleSection && (
            <div className="group relative">
              <Button
                ...
                onClick={async () => {
                  ...
                  analytics.trackUserEvent(
                    SegmentHandler.EVENTS.COMPETITION_CREATE_PHASE_1,
                    competition.create
                  );
                  // const isExist = await checkCompetitionName(competitionName);
                  // if (isExist) {
              ...
              <div className="hidden group-hover:flex flex-col items-center competitionStatesBlock">
                {!Boolean(
                  competition.create.image?.url ||
                    competition.create.image?.emoji
                ) && (
...
export default CreateCompetitionPhase1;
